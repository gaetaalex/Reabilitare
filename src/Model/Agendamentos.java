...
public class Agendamentos {
    ...
    private String status;
     ...
     public Agendamentos(int id, Pacientes pacientes, Servicos servicos, Servicos valor, String dataHora, String Observacao, String status) {
         this(id, pacientes, servicos, valor, dataHora, status);
         this.observacao = observacao;
    }
     
    public Agendamentos(int id, Pacientes pacientes, Servicos servicos, Servicos valor,  String dataHora, String status) {
        this.id = id;
    ...
    /*public Agendamentos(int id, Pacientes pacientes, Servicos servicos, Servicos valor, String data, String Observacao, String status) {
        this.id = id;
        this.pacientes = pacientes;
        this.servicos = servicos;
        this.valor = valor;
    ...
    public Agendamentos(int id, Pacientes pacientes, Servicos servicos, float valor, String dataHora, String observacao) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
